...
urlpatterns = [
    ...
    path('<int:mainCategoryId>/<int:categoryId>/showCategoryValues/<str:propertyName>', positionViews.showCategoryDeleteView, name='categoryValueDelete'),
    path('<int:mainCategoryId>/<int:categoryId>/showCategoryValues/<str:propertyName>/confirm', positionViews.showCategoryDeleteExecute, name='categoryValueDeleteConfirm'),
