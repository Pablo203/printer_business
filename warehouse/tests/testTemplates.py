...
class TemplatesTest(TestCase):
    ...
    def test_warehouse_main_view(self):
        ...
        self.assertTemplateUsed(response, "warehouseMain.html")
    ...
    def test_category_values_list(self):
        ...
        self.assertTemplateUsed(response, "categoryvalue_list.html")
    ...
    def test_category_values_delete_view(self):
        ...
        self.assertTemplateUsed(response, "confirmCategoryValueDelete.html")
    ...
    def test_category_values_create(self):
        ...
        self.assertTemplateUsed(response, "categoryValueCreate.html")